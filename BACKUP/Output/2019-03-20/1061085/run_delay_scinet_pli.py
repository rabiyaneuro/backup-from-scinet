...
This file sets parameters for the WC brain scale model- computes the PLI
using randomly generated anatomically data or importing from cocomaq. It runs the
optimization to find the best delays to generate the system which has a PLI
...
res = df.differential_evolution(hf.residuals_pli, args = args,
...
if evol_params['optim'] =='w':
    MAT = c_mat
#    final_res = hf.residuals_cw_corr(res.x, wc_params, nodes, targ_data, MAT, 
