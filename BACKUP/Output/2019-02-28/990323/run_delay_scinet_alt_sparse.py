...
res = df.differential_evolution(hf.residuals_cw_corr_sparse, args = args,
...
#                                     skip, wc_seed, evol_params['optim'], tract_mat, heavyside= evol_params['heavi'])
    ...
    MAT = w_mat
    final_res = hf.residuals_cw_corr_sparse(res.x, wc_params, nodes, targ_data, MAT,
                                            skip, wc_seed, evol_params['optim'], tract_mat, heavyside= evol_params['heavi'])
elif evol_params['optim'] =='d':
    MAT = w_mat
#    final_res = hf.residuals_cw_corr(res.x, wc_params, nodes, targ_data, MAT, 
#                                     skip, wc_seed, evol_params['optim'], heavyside= evol_params['heavi'])
