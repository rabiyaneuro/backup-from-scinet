...
"""def residuals_cw_corr(c, params, targ_data, nodes, tract_mat, cw_mat, skip, seed, optim,
                   final = False):"""
args = (wc_params, targ_data, nodes, tract_mat, c_mat, skip, wc_seed, evol_params['optim'])