...
import differentialevolution_par_scinet_discrete_temp as df
import numpy as np
...
"""def residuals_cw_corr(c, params, nodes, targ_data, cw_mat, skip, seed,
 optim, tract_mat=None, heavyside =False,
                   plot = None)

residuals_cw_corr_sparse(c, params, nodes, targ_data, cw_mat, skip, seed, 
optim, tract_mat, heavyside =False):"""
