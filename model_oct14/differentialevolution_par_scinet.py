...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
                           ...
                           mse_thresh = 1, rank = None, size = None,
                           comm = None, jobid =None):
    ...
    solver = DifferentialEvolutionSolver(func, bounds, args=args,
                                         ...
                                         prior = prior,
                                         mse_thresh= mse_thresh, rank = rank,
...
class DifferentialEvolutionSolver(object):
    ...
    def __init__(self, func, bounds, args=(),
                 ...
                 rank = None, size = None, comm = None, jobid=None):
...
#        self.num_population_members = int(popsize * self.parameter_count)
    ...
    def init_population_lhs_mod(self,pop_remaining):
        ...
        # Within each segment we sample from a uniform random distribution.
        # We need to do this sampling for each parameter.
        samples = (segsize * rng.random_sample((pop_remaining, self.parameter_count))
        ...
        self.population = np.concatenate((self.population, pop_remaining_array),
                                         axis=0)
    ...
    def init_pre_selected(self, list_of_solutions):
        ...
        if len(list_of_solutions) < self.num_population_members:
            self.init_population_lhs_mod(self.num_population_members-len(list_of_solutions))
...
#            print(self.population[i,:])
        ...
        for nit in xrange(1, self.maxiter + 1):
            ...
            # if nit ==1 or nit%500 == 0:
                # np.save("{}/scratch_/rank{}_nit{}_cost{}.npy".format(self.jobid,self.rank,nit,self.population_energies[0]), self._scale_parameters(self.population[0]))
...
#                break
    ...
    def migration(self):
        ...
        pop_send = np.copy(self.population[0]) #best member from current population
