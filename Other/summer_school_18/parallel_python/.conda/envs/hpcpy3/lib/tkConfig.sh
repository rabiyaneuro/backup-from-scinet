...
# installed.
TK_PREFIX='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/workdir/conda-build/tk_1502813427692/work/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/include'
...
# compiled.
TK_SRC_DIR='/workdir/conda-build/tk_1502813427692/work'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/workdir/conda-build/tk_1502813427692/work/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/workdir/conda-build/tk_1502813427692/work/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib/libtkstub8.6.a'
