...
# installed.
TCL_PREFIX='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3'
...
TCL_EXTRA_CFLAGS='-Wformat -Wformat-security -D_FORTIFY_SOURCE=2 -fstack-protector -O3 -fpic -fPIC -pipe '
...
TCL_LD_FLAGS='-z noexecstack -z relro -z now -fstack-protector -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/workdir/conda-build/tcl_1518417028030/work/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/include'
...
# compiled.
TCL_SRC_DIR='/workdir/conda-build/tcl_1518417028030/work'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/workdir/conda-build/tcl_1518417028030/work/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/workdir/conda-build/tcl_1518417028030/work/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/bb/scinet/course/ss2018/2_ds/4_parallelpython/.conda/envs/hpcpy3/lib/libtclstub8.6.a'
